...
export default [
  ...
  },
  {
    ...
    note: '2026格式无变化，纯电动优先D，非纯电动优先F；部分地区试点8位但主流仍7位',
  },
  {
    title: '车牌号(非新能源)',
  ...
  },
  {
    ...
    rule: /^(?:(?:\+|00)86)?1(?:(?:3[0-9])|(?:4[5-9])|(?:5[0-35-9])|(?:6[5-7])|(?:7[0-8])|(?:8[0-9])|(?:9[0-35-9]))\d{8}$/,
    examples: [
      '008618311006933',
      '+8617888829981',
      '19119255642',
    ...
    note: '2026更新：覆盖所有主流段（含190/191/192/193/195/196/197/198/199等5G/虚拟运营商）；不含纯物联网专段',
  },
  {
  ...
  },
  {
    ...
    note: '2026新增：简单判断是否为合法JSON结构（兼容 es5/es2015 target）',
  },
  {
    title: 'HTML实体编码',
    rule: /&[a-zA-Z0-9#]+;/,
    examples: ['&amp;', '&#39;', '&lt;'],
    note: '2026新增：常见HTML实体',
  },
] as Rule[];
